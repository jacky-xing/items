...
module.exports = {
    register:(app) => {
        ...
        // 对指定的商品进行查询
        app.get("/assproducts", filter, (req, res) => {
            let page = req.query.page;
            let limit = req.query.limit;
            page1 = page ? (page-1)*limit : 0;
            limit1 = limit ? page*limit : 99999;
        ...
        app.get("/dimproducts", filter, (req, res) => {
        ...
        // 添加商品路由
        app.get("/addproduct", filter, (req, res) => {
        ...
        // 删除商品路由
        app.get("/delproduct", filter, (req, res) => {
            let id = req.query.id;
        ...
        // 更新商品路由
        app.get("/updproduct", filter, (req, res) => {
